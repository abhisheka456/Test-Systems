function mpc = case3ph32
       Feeder = LoadFeeder('FEEDER32_four_conductor.xlsx');
       ...
       %% droop busses
       mpc.nDG = 6;
       mpc.DGs = [2,3,13,18,20,27];
       mpc.mp  = [0.005,0.005,0.005,0.005,0.005,0.005]*1e0;
       mpc.nq  = [0.05,0.05,0.05,0.05,0.05,0.05]*1e0;
       mpc.w0   = 1;
       mpc.Pdg  = 5*ones(1,6)*1e-2;
       mpc.Qdg  = 3*ones(1,6)*1e-2;
       mpc.Z    = 1e-8;
       mpc.Z    = 14;
       mpc.Pref = mpc.Pdg/2;
       mpc.Qref = mpc.Qdg/2;
