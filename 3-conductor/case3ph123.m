function mpc = case3ph123
       ...
       %% droop busses
       mpc.nDG = 16;
       mpc.DGs = [13,19,25,27,31,35,45,58,69,75,81,83,87,91,101,114];
       mpc.mp  = [0.005,0.01,0.005,0.005,0.01,0.05,0.005,0.01,0.005,0.01,0.005,0.005,0.01,0.05,0.005,0.01];
       mpc.nq  = [0.05,0.1,0.01,0.05,0.01,0.001,0.01,0.05,0.05,0.1,0.01,0.05,0.01,0.001,0.01,0.05];
       mpc.w0   = 1;
end