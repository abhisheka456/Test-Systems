function mpc = case3ph59
       Feeder = LoadFeeder('FEEDER IEEE59_SINREGULADOR.xlsx');
       ...
       %% droop busses
       mpc.nDG = 8;
       mpc.DGs = [13,19,25,27,31,35,45,58];
       mpc.mp  = [0.005,0.01,0.005,0.005,0.01,0.05,0.005,0.01];
       mpc.nq  = [0.05,0.1,0.01,0.05,0.01,0.001,0.01,0.05];
       mpc.w0   = 1;
end